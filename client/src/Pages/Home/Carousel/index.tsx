                    ...
                    <div key={ Math.random() } className='p-3 flex h-[100%]'>
                      <div className='rounded-2xl overflow-hidden flex flex-col flex-1 shadow-lg'>
                        ...
                        <div className='p-4 bg-[#2A2A2C] flex-1 flex flex-col justify-between'>
                          ...
                          <p className='text-white text-[15px] mb-3'><span className='font-semibold'>Authors:</span> {parseInt(a.member) > 10 ? a.member:`0${a.member}`}</p>
                          <p className='md:text-[16px] text-[15px] text-[#FFF] font-inter font-medium mb-3 line-clamp-3'>{a.overview}</p>
