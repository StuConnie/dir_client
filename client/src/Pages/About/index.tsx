            ...
            <div className='mx-auto max-w-[1250px] lg:pt-[115px] md:pt-[115px] pt-[100px] pb-5 px-3 mb-8 howiT'>
                ...
                <div className='flex justify-center divH'>
                    ...
                    <div className='w-[33%] m-4 listOH'>
                        ...
                        <div className='pCIT'>
                            <p className='text-[16px] text-[#291943] font-semibold text-center mt-7 pC pCT'>Sign in with VMSC Account.</p>
                            <p className='text-[15px] text-[#291943] font-medium text-center mt-4 pC pCI'>Our website is only accepting VMSC accounts for the students of this school.</p>
                        </div>
                    </div>        
                </div>
            </div>
