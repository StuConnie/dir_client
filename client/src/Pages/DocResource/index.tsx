            ...
            if(auth[0]){
                let funcD = async () => {
                    ...
                    try{
                        ...
                        let obj = {
                            method: 'POST',
                            url: 'https://directory-client-server-puce.vercel.app/getSelected',
                        ...
                        if(data.success){
                            ...
                            obj.method = "GET";
                            obj.url = "https://directory-client-server-puce.vercel.app/getRateDocument";
        ...
        if(auth[0]){
            if(!disableBttn){
                ...
                try{
                    ...
                    let obj = {
                        method: 'POST',
                        url: 'https://directory-client-server-puce.vercel.app/giveRate',
                        params: { /* This is for GET method */ },
            ...
            if(rates !== rate[1]){
                if(!disableBttn){
                    ...
                    try{
                        ...
                        let obj = {
                            method: 'POST',
                            url: 'https://directory-client-server-puce.vercel.app/updateRate',
                            params: { /* This is for GET method */ },
                            ...
                            <div className='md:w-[72%] w-[100%] bg-white md:p-8 p-5 rounded-lg shadow-lg overflow-hidden'>
                                {
                                    dataFetch === 'done' ?
                                    <div>
                                        <p className='sm:text-[21px] text-[19px] text-[#29292d] font-semibold'>{data[0].title}</p>
                                        <p className='sm:text-[15px] text-[14px] mb-4'>
                                            <p><span className='font-bold'>• Authors: </span>{data[0].member.padStart(2, '0')}</p>
                                            <p><span className='font-bold'>• Track: </span>{data[0].course}</p>
                                            <p><span className='font-bold'>• Year: </span>{data[0].year}</p>
                                            <p><span className='font-bold'>• Overview: </span>{data[0].overview}</p>
                                        </p>  
