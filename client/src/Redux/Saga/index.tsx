...
function* ResourcesTitleCourses({ condition, titleCourse, skip }: any){
    try{
        let obj = {
            method: 'GET',
            url: 'https://directory-client-server-puce.vercel.app/getBy_CourseTitle',
...
function* TopThreeeResearchs({ type }: any){
    try{
        let obj = {
            method: 'GET',
            url: 'https://directory-client-server-puce.vercel.app/getTopTreeResources',
...
function* TopOtherResearchs({ type }: any){
    try{
        let obj = {
            method: 'GET',
            url: 'https://directory-client-server-puce.vercel.app/getTopOthersResources',
            params: { /* This is for GET request */ },
            data: { /* this is for POST request */ },
            headers: {
                'Content-type': 'application/json'
